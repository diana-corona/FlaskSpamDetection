...
classifier = DecisionTreeClassifier(criterion='gini', splitter='best', max_depth=None, min_samples_split=2, min_samples_leaf=1)
...
# Save
dump(DecisionTree_pipeline, 'models/spam_classifier_DecisionTree.joblib')